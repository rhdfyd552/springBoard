...
<h1>formBoard</h1>
    <div class="container-fluid">
      <div class="row">
		...
		<form action="${pageContext.request.contextPath }/board/insertReplyBoard"  method="post" id="frm" enctype="multipart/form-data">
			<div class="form-group">
				<label class="col-sm-2 control-label">게시판</label>
					<input type="text" value="${noticeName }" readonly="readonly">
					<input type="hidden" name="category_seq" value="${category_seq}">
					<input type="hidden" name="pboard_seq" value="${boardVo.board_seq}">
			</div>	
 			<input type="hidden" name="reg_id" value="${loginUser }">
			<div class="form-group">
