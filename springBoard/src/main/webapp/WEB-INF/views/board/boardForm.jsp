...
<h1>formBoard</h1>
    <div class="container-fluid">
      <div class="row">
		...
		<form action="${pageContext.request.contextPath }/board/insertBoard"  method="post" id="frm" enctype="multipart/form-data">
			...
			<input type="button" id="savebutton" value="게시글입력" />
		</form>
		</div>
	</div>
</div>
